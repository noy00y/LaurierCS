/*QUESTION:::::
 ...
 ID:           200143300
 Email:        heali@wlu.ca & dbrown@wlu.ca & khan3300@mylaurier.ca
 Version:      2017-06-29
 Modified:     2022-03-04
 -------------------------------------------------------
 */
...
//==============================================
{
	avl_node *a = node->right;
	avl_node *b = a->left;
	a->left = node;
	node->right = b;
	node->height = MAX_HEIGHT(avl_node_height(node->left),
			avl_node_height(node->right)) + 1;
	a->height = MAX_HEIGHT(avl_node_height(a->left),
			avl_node_height(a->right)) + 1;
	return (a);
}
...
//================================================
{
	...
	if (node->left != NULL && node->left->data > node->data)
		return 0;
	// Case 2: Right Smaller
	if (node->right != NULL && node->right->data < node->data)
		return 0;
	if (!avl_valid_aux(tree, node->left, NULL, NULL)
			|| !avl_valid_aux(tree, node->right, NULL, NULL))
		return 0;
